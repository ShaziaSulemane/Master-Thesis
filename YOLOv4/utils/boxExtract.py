...
if __name__ == '__main__':
    save_dir = "../config/mask_train.txt"
    image_dir = "D:/Python_Code/Mask_detection/MaskDetection/images"
    label_dir = "D:/Python_Code/Mask_detection/MaskDetection/annotations"

    box_extract = BoxExtract(save_dir)
    box_extract.build_map(image_dir, label_dir)
